...
final class CaptureOverlayView: NSView {
    ...
    init(configuration: Configuration, windowMode: Bool) {
    ...
    private func setUpLayers() {
        ...
        for sublayer in [imageLayer, dimLayer, highlightLayer, selectionBorder, loupeLayer, loupeOverlay, labelBackground] {
